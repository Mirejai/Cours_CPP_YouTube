...
int main() {
	...
	// Ici on met nombre_1 <= 10 car si on mettait < on n'aurait pas la table de 10
	for (int nombre_1 = 0 ; nombre_1 <= 10 ; nombre_1++){
		...
		for (int nombre_2 = 0 ; nombre_2 <= 10 ; nombre_2++) // Si le code de la boucle ne comprend qu'une instruction on n'est pas obligé de mettre des accolades.
	...
	return 0; // On n'oubli pas return 0; bien sûr.
